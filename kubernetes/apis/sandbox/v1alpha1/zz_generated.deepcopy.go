...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KataVMStateSnapshot) DeepCopyInto(out *KataVMStateSnapshot) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KataVMStateSnapshot.
func (in *KataVMStateSnapshot) DeepCopy() *KataVMStateSnapshot {
	if in == nil {
		return nil
	}
	out := new(KataVMStateSnapshot)
	in.DeepCopyInto(out)
	return out
}
...
func (in *SandboxSnapshotStatus) DeepCopyInto(out *SandboxSnapshotStatus) {
	*out = *in
	...
	if in.KataVMState != nil {
		in, out := &in.KataVMState, &out.KataVMState
		*out = new(KataVMStateSnapshot)
		**out = **in
	}
	if in.Conditions != nil {
