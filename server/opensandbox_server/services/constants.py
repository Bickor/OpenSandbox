...
# Server-injected operator configuration; never accepted from sandbox request env.
OPENSANDBOX_EGRESS_CREDENTIAL_PROVIDER_CONFIG = "OPENSANDBOX_EGRESS_CREDENTIAL_PROVIDER_CONFIG"
